...
1. **System estimates (buy_type = 1)**  
   - Please ensure that the received_address holds the token corresponding to the contracted_address, otherwise the miner fee estimation will fail
   - Only allow the purchase of energy,Purchasing bandwidth is not supported. 
